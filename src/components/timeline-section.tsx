        ...
        <div className="glass rounded-2xl p-8 overflow-x-auto bg-background/5 backdrop-blur-sm border border-white/10">
          ...
          <div className="relative" style={{ height: "480px" }}>
            ...
            <div className="absolute inset-0 pointer-events-none">
              {timeSlots.map((time, index) => {
                // Only draw for full hours (e.g., "9:00", "10:00", ...)
                if (
                  /^\d{1,2}:00$/.test(time) &&
                  index > 0 &&
                  index < timeSlots.length - 1
                ) {
                  // Position: halfway between previous and next slot
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        height: "100%",
                        width: "0px",
                        borderLeft: "2px dashed #a3a3a3", // or your preferred style
                        opacity: 0.3,
                        zIndex: 1,
            ...
            {timelineEvents.map((event, index) => {
              ...
              // Shift left by half a slot so event starts at the center of its slot
              const left = (position + 0.5) * slotWidth;
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    transform: "translateX(-50%)", // Center the block on the grid line
                  }}
                >
