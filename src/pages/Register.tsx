                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="ai-ml">Tech Innovation</SelectItem>
                      <SelectItem value="mobile">Tech Debates</SelectItem>
                      <SelectItem value="blockchain">UI/UX Design</SelectItem>
                      <SelectItem value="design">AdZap</SelectItem>
                      <SelectItem value="pitch">Tech Pictionary</SelectItem>
                      <SelectItem value="quiz">Tagline Twist</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
            ...
            <div className="glass rounded-2xl p-8">
              <div className="space-y-6">
                <div className="text-sm text-foreground/70">
                  <p>By registering for Sympo 2025, you agree to:</p>
